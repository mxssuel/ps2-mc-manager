...
import { MEMORYCARD, NOT_MIN_SIZE_MEMORYCARD, NOT_FORMATTED_MEMORYCARD } from "../../mock/memorycard.mock"
...
describe("Invalid MemoryCard", () => {
    ...
    it("Not Valid Version", () => {
        ...
        const result = [false, `The version ${not_valid_mc_version.superblock.version} is invalid and not in the format 1.x.0.0 on the memory card.`]
