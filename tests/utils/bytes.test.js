...
describe("Error Byte Functions", () => {
  describe("Read Uint16", () => {
    ...
    it("Offset Out Of Bounds", () => {
      ...
      const offset = 2
      const result =
        "Attempted to read out of bounds. Offset 2 (length 2) exceeds available bytes length 3."
  ...
  describe("Read Int32", () => {
    ...
    it("Offset Out Of Bounds", () => {
      ...
      const offset = 1
      const result =
        "Attempted to read out of bounds. Offset 1 (length 4) exceeds available bytes length 4."
  ...
  describe("Read Int 32 List", () => {
    ...
    it("Offset Out Of Bounds - Start NaN", () => {
      ...
      const offset = ["a", 0]
      const result =
        "Invalid 'start' or 'end' parameters. They must be non-negative numbers where 'start' <= 'end'."
    ...
    it("Offset Out Of Bounds - Exceeded maximum number of bytes - Inclusive", () => {
      ...
      const offset = [0, 12]
      const result =
        "Attempted to read out of bounds. Range [0, 12] (length 4) exceeds available bytes length 12."
    ...
    it("Offset Out Of Bounds - Exceeded maximum number of bytes - Exclusive", () => {
      ...
      const offset = [0, 13]
      const result =
        "Attempted to read out of bounds. Range [0, 13] (length 4) exceeds available bytes length 12."
    ...
    it("Offset Out Of Bounds - It is not a multiple of 4 - Uint8", () => {
      ...
      const offset = [0, 13]
      const result =
        "Calculated byte length (13 bytes) is not a multiple of 4 size, which is required for reading values."
    ...
    it("Offset Out Of Bounds - It is not a multiple of 4 - Range", () => {
      ...
      const offset = [0, 11]
      const result =
        "Calculated byte length (11 bytes) is not a multiple of 4 size, which is required for reading values."
  ...
  describe("Validate Byte Checksum", () => {
    ...
    it("Offset Out Of Bounds - Exceeded maximum number of bytes - Only Exclusive", () => {
      ...
      const offset = [0, 13]
      const result =
        "Attempted to read out of bounds. Range [0, 13] (length 1) exceeds available bytes length 12."
